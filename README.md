...
* `basket:change` - Обновляет счётчик корзины в шапке приложения и обновляет данные корзины.
...
* `buyer:change` - обрабатывает данные полученные из формы в модель данных.
